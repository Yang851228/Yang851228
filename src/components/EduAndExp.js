    ...
    <div>
        <div>
            ...
            <div className={styles.education}>
                <div>2015.09 - 2019.06</div>
                <div>淡江大學 風險管理與保險系 學士</div>
            </div>
        </div>
        <div>
            <div className={styles.subTitle}>
            ...
            <div className={styles.experience}>
                ...
                <div className={styles.rightColumn}>
                    <div>
                        ...
                        <div>使用技術:  Java、Spring、Spring Boot、Hibernate、JSP、HTML、CSS、JavaScript、jQuery、Ajax、MS SQL Server、WebSphere、IBM BPM、JPA、MS Office</div>
                    </div>
                </div>
            </div>
        </div>
